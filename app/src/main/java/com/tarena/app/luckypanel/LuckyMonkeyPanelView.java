                    ...
                    post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (isTryToStop && currentSpeed == DEFAULT_SPEED && stayIndex == currentIndex) {
                                isGameRunning = false;
                                Log.i("luck","currentIndex:"+currentIndex );


                                PanelItemView p = currentIndex+1>=8?(PanelItemView) itemViewArr[0]:  (PanelItemView) itemViewArr[currentIndex+1];

                                Log.i("luck","PanelItemView:"+p.getNumber() );


                                callBack.getScore(Integer.parseInt(p.getNumber()));
