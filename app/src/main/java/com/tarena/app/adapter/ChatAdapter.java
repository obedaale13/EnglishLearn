...
public class ChatAdapter extends  BaseAdapter<EMMessage>{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (null == view ) {
            ...
            if (BmobUser.getCurrentUser().getUsername().equals(sc.getFrom())){
                ...
                view = getLayoutInflater().inflate(R.layout.item_chat_left, null);
                holder.iv_head = (CircleImageView) view.findViewById(R.id.item_iv_chat_head_left);
                holder.tv_content = (TextView) view.findViewById(R.id.item_tv_chat_content_left);
                holder.layout_images = (RelativeLayout) view.findViewById(R.id.lv_imagesLayout_left);
                view.setTag(holder);
            }
        ...
        if (sc.getType() == EMMessage.Type.TXT){
            ...
            lp.width =  0;
            lp.height = 0;
            EMTextMessageBody body = (EMTextMessageBody) sc.getBody();
